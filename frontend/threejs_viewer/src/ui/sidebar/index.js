 ...
 * 
 * @changelog
 * - v1.2.0: 🆕 리팩토링된 모듈 추가 (2026-01-25)
 *           - handlers/ 폴더 모듈 export 추가
 *           - managers/ 폴더 모듈 export 추가
 *           - SidebarClickHandlers, SidebarEventHandlers export
 *           - SidebarViewManager, SidebarStateManager export
 *           - 유틸리티 함수 export (getParentModeForSubmode, mapToNavMode 등)
 ...
 * 
 *   // 🆕 v1.2.0: 분리된 매니저/핸들러 직접 사용
 *   import { SidebarViewManager, SidebarStateManager } from './ui/sidebar/index.js';
 *   import { SidebarClickHandlers, getParentModeForSubmode } from './ui/sidebar/index.js';
 * 
 * 파일 구조:
 *   src/ui/sidebar/
 *   ├── index.js                    # 이 파일
 *   ├── Sidebar.js                  # 메인 사이드바 컴포넌트 (조율자)
 *   ├── StatusBar.js                # 하단 상태바 컴포넌트
 *   ├── CoverScreen.js              # 커버 스크린 컴포넌트
 *   ├── IconRegistry.js             # SVG 아이콘 레지스트리
 *   ├── SidebarConfig.js            # 상수/설정
 *   ├── ConnectionModalManager.js   # Connection Modal 관리자
 *   ├── SidebarButtonFactory.js     # 버튼 생성 유틸리티
 *   ├── SidebarSubmenuFactory.js    # 서브메뉴 생성 유틸리티
 *   ├── handlers/                   # 🆕 v1.2.0
 *   │   ├── index.js
...
export {
    ...
    getSubmodeMapping,
    isRankingViewEnabled
} from './SidebarConfig.js';

// ============================================
// Connection Modal Manager Export
// ============================================
...
export const SOURCE = 'Sidebar Refactoring v2.0.0';
